  ...
  group('DistanceUtils', () {
    group('toRadians', () {
      ...
      test('should convert 90 degrees to pi/2 radians', () {
        expect(
          DistanceUtils.toRadians(90),
          closeTo(1.5708, 0.0001),
        );
      });

      test('should convert 180 degrees to pi radians', () {
        expect(
          DistanceUtils.toRadians(180),
          closeTo(3.1416, 0.0001),
        );
      });

      test('should convert 360 degrees to 2*pi radians', () {
        expect(
          DistanceUtils.toRadians(360),
          closeTo(6.2832, 0.0001),
        );
      });
    ...
    group('calculateHaversineDistance', () {
      ...
      test('should calculate correct distance between Kuala Lumpur and Penang', () {
        // KL: 3.1390, 101.6869
      ...
      test('should handle crossing the equator', () {
        final distance = DistanceUtils.calculateHaversineDistance(
          1.0, 100.0, // North of equator
          -1.0, 100.0, // South of equator
        );
        // About 222 km
      ...
      test('should handle crossing the prime meridian', () {
        final distance = DistanceUtils.calculateHaversineDistance(
          51.5074, -0.1, // West of prime meridian (London)
          51.5074, 0.1, // East of prime meridian
        );
        // About 14 km
